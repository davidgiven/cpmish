...
the license of everything else). See the [COPYING.gpl2.md](COPYING.gpl2.md) file
for more details.
...
Specifically:
  ...
  - Everything _not_ in `arch` or `third_party` is © 2018-2019 David Given and
	...
	[COPYING.cpmish.md](COPYING.cpmish.md) file for more details.
  ...
  - `third_party/libstb` contains a copy of Sean Barrett's stb utility library.
	It is partially in the public domain and partiall distributable via the
	Expat license. See the
	[third_party/libstb/COPYING.md](third_party/zcpr1/COPYING.md) file for more
	details.
  ...
  - `third_party/zcpr1` contains a (modified) copy of the ZCPR1 CCP
	...
	the [third_party/zcpr1/COPYING.md](third_party/zcpr1/COPYING.md) file for
	more details.
  ...
  - `third_party/zmac` contains a (modified) copy of the ZMAC macro assembler,
	...
	See the [third_party/zmac/COPYING.md](third_party/zmac/COPYING.md) file for
	more details.
  ...
  - `third_party/zsdos` contains a (modified) copy of the ZSDOS CP/M BDOS
	...
	version 2. See the
	[third_party/zsdos/COPYING.md](third_party/zsdos/COPYING.md) file for more
	details.
